...
import { Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, IconButton, MenuItem, Pagination, Select, Stack, Table, TableBody, TableCell, TableHead, TableRow, TextField } from "@mui/material";
...
const Transactions: FC<Props> = ({ api }) => {
    ...
    const loadTransactions = async () => {
        ...
        await api.transactions.getTransactions({ budget_id: selectedBudget })
            .then(data => data.mapRight(tr => {
                setTransactions(tr);
            }));
    }
    ...
    return (
        <>
            ...
            <Fragment>
                ...
                {transactions.length > itemsPerPage && <Box
                    alignItems='center'
            ...
            <Dialog open={dialogOpen} onClose={closeDialog}>
                ...
                <DialogContent>
                    <Stack spacing={3}>
                        ...
                        <Select label='Бюджет' value={selectedBudget}
                            onChange={(e) => {
                ...
                <DialogActions>
                    ...
                    <Button onClick={async () => {
                        ...
                        await api.transactions.addTransaction(newTransaction)
                            .then(() => {
